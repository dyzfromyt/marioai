...
//                System.err.println("It is good day to kill yourself with the yellow wall");
        ...
        GlobalOptions.FPS = (isMaxFPS()) ? GlobalOptions.InfiniteFPS : GlobalOptions.ourFPS /*GlobalOptions.FPS*/;
    ...
    public void setMaxFPS(boolean isMaxFPS ) {
        ...
        GlobalOptions.FPS = (isMaxFPS()) ? GlobalOptions.InfiniteFPS : GlobalOptions.ourFPS ;
    }
