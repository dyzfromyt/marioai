...
public class Enemy extends Sprite
{
    ...
    private Enemy(LevelScene world)
    {
        super(world);
    }
            ...
            if (yMarioD > -height && yMarioD < world.mario.height)
            {
                if (type != Enemy.ENEMY_SPIKY && world.mario.ya > 0 && yMarioD <= 0 && (!world.mario.onGround || !world.mario.wasOnGround))
                {
                    ...
                    else
                    {
                        ...
                        world.setTemplateDead(this.templateX, this.templateY);
                        deadTime = 10;
                        winged = false;
...
//                System.out.println("fireballCollideCheck");
    ...
    {
        Enemy result = new Enemy((LevelScene) parent);
        ...
        result.flyDeath = flyDeath;
        result.avoidCliffs = avoidCliffs;
        result.type = type;
        result.winged = winged;
        result.wingTime = wingTime;
        result.noFireballDeath = noFireballDeath;
        return result;
    }
}